...
export default function Footer() {
  return (
    <footer className="footer bg-neutral-100">
      <div className="container mx-auto p-12 px-6 flex items-center justify-between max-md:flex-col max-md:gap-10">
        ...
        <div className="content grid gap-3 max-md:w-full">
          <h3 className="title text-[18px] text-slate-800 font-bold">روابط مهمة</h3>
        ...
        <div className="content grid gap-3 max-md:w-full">
          <h3 className="title text-[18px] text-slate-800 font-bold">تواصل معي</h3>

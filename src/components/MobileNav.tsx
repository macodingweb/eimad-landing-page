...
export default function MobileNav({ items, isOpened, setIsOpened } : MobileNavProps) {
  return (
    <>
      ...
      <div className={`mobile__nav hidden max-lg:block fixed top-0 h-[100vh] bg-[#7f764f] w-[280px] pt-[100px] transition-all ease-in-out duration-[400ms] px-6 ${ isOpened ? "left-0" : "-left-full" }`}>
        {/* Close Btn */}
